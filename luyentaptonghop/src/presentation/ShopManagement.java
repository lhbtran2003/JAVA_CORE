...
public class ShopManagement {
    ...
    private static void listProductNameAndQuantity(Scanner sc) {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 8:
                    ...
                    boolean isSold = sellProduct(productName, quantity);
                    if (isSold) {
                        System.out.println("Đã bán "+quantity+" sản phẩm: "+productName);
                    } else {
                        System.out.println("Bán ko thành công!");
                    }
